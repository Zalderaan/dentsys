...
#define MyAppURL "-"
#define MyAppExeName "dentsys_client_prod.exe"
...
Source: "C:\xampp\htdocs\dentsys\dentsys_client\build\windows\x64\runner\Release\screen_retriever_plugin.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\xampp\htdocs\dentsys\dentsys_client\build\windows\x64\runner\Release\window_manager_plugin.dll"; DestDir: "{app}"; Flags: ignoreversion
