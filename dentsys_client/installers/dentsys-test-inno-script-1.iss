...
AppId={{B5713F32-9E12-4CD6-ACB1-A53B0AC466D0}
AppName={#MyAppName}
...
OutputBaseFilename=dentsys-setup
Compression=lzma
...
[Files]
Source: "C:\xampp\htdocs\dentsys\dentsys_release\Release\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\xampp\htdocs\dentsys\dentsys_release\Release\flutter_windows.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\xampp\htdocs\dentsys\dentsys_release\Release\screen_retriever_plugin.dll"; DestDir: "{app}"; Flags: ignoreversion
